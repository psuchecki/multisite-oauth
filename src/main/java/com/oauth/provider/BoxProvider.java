...
public class BoxProvider extends DefaultApi20 {
    public static final String AUTHORIZE_URL =
            "https://app.box.com/api/oauth2/authorize?client_id=%s&response_type=code&redirect_uri=%s";
    public static final String ACCESS_TOKEN_ENDPOINT = "https://app.box.com/api/oauth2/token";
